...
const PropertyDetails = () => {
  //get the house id
  const { id } = useParams(); //this id is string!!!

  //get the related house based on id
    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14 ">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className=" bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 flex-1">
            ...
            <form className="flex flex-col gap-y-2">
              ...
              <textarea
                ...
                placeholder="Message*"
                defaultValue="Hello, I am interested in modern houses."
              ></textarea>
              <div className="flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition">
                  Send Message
                </button>
                <button className="border border-violet-700 text-violet-700 hover:border-violet-500 hover:text-violet-500 transition rounded p-4 text-sm w-full">
                  Call
                </button>
              </div>
            </form>
